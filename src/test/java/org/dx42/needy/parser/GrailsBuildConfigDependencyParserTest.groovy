...
class GrailsBuildConfigDependencyParserTest extends AbstractTestCase {
	...
	void test_parse_FullGradleBuildFile() {
		String source = new File('src/test/resources/sample1-grails-buildconfig.groovy').text
...
//			}
//		'''
//		assert parser.parse(NAME, SOURCE).size() == 25
//	}
//
//	@Test
...
//			}
//		"""
//		assert parser.parse(NAME, SOURCE).size() == 1
//	}
//
...
//		}"""
//		assert parser.parse(NAME, SOURCE) == [
//			new Dependency(applicationName:NAME, configuration:"runtime", group:"org.codehaus.groovy", name:"groovy-all", version:"2.4.10"),
//			new Dependency(applicationName:NAME, configuration:"runtime", group:"commons-cli", name:"commons-cli", version:"1.0"),
//			new Dependency(applicationName:NAME, configuration:"runtime", group:"org.apache.ant", name:"ant", version:"1.9.6"),
//		]
//	}
//
//	@Test
...
//			new Dependency(applicationName:NAME, configuration:"runtime", group:"org.codehaus.groovy", name:"groovy-all", version:"2.4.10"),
//			new Dependency(applicationName:NAME, configuration:"runtime", group:"commons-cli", name:"commons-cli", version:"1.0"),
//			new Dependency(applicationName:NAME, configuration:"runtime", group:"org.hibernate", name:"hibernate", version:"3.0.5"),
//		]
//	}
//
//	@Test
...
//		shouldFail { parser.parse(NAME, "dependencies { compile '' }") }	
//	}
//
//	@Test
//	void test_parse_IllegalGroovySyntax() {
//		shouldFail(IllegalStateException) { parser.parse(NAME, "%^@ &*[]") }	
//	}
