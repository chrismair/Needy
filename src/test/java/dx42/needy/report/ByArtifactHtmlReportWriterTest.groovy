...
class ByArtifactHtmlReportWriterTest extends AbstractTestCase {
	...
	private static final String EXPECTED_REPORT_TEXT = """
		<html><head><title>Needy Dependency Report: Dependency Report</title><style type='text/css'>$CSS</style></head>
	...
	void test_writeReport_EmptyDependencies_SetTitle() {
		final EXPECTED = """
			<html><head><title>Needy Dependency Report: My Title</title><style type='text/css'>$CSS</style></head>
